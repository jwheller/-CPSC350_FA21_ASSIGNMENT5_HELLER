...
void FileProcessor::makeArrayFromFile(string readFileName){ //Reurns each line as an
//element in an array

    getLengthOfFile(readFileName); 
    linesArray = new string[numLines];
...
void FileProcessor::getLengthOfFile(string readFileName){
